...
class TinderBot():
    ...
    _COORD_LIST = (
                '517|367', '517|369', '515|369', '514|368', '514|367', '512|367', '511|369',
                   '517|375', '507|365', '505|377', '508|377', '512|368', '513|367', '512|366', '514|366', '514|386',
                   '504|393', '504|386', '503|378', '500|378', '495|378', '497|381',
                   '497|368', '496|363', '495|366', '493|358', '497|359', '498|358', '498|357',
                   '502|360', '503|359', '509|358', '508|359', '507|358', '507|363', '504|370', '531|393'

                   )

    _COORD_LIST_2 = (
        '491|366', '490|366', '491|373', '485|372', '488|376',
        '488|377', '485|377', '488|379', '483|370', '486|361', '486|369', '488|369', '487|367'
    )
    _COORD_LIST_3 = ('520|365', '523|365', '525|363',
                     '526|362', '524|366', '522|367', '520|367', '522|369', '521|371', '523|373',
                     '520|374', '527|369', '526|371', '527|371', '521|381', '522|382', '527|377', '528|377', '529|375',
                     '523|384', '529|383', '528|388', '523|387', '524|389', '523|390', '528|391',
