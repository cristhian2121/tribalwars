...
class TinderBot():
    ...
    _COORD_LIST = ('518|368', '517|367', '517|369', '515|369', '514|368', '514|367', '512|367', '511|369', '518|375',
                   ...
                   '507|399', '504|393', '504|386', '503|378', '500|378', '495|378', '497|381',
                   '498|380', '497|368', '496|363', '495|366', '493|358', '497|359', '498|358', '498|357',
                   '501|359', '502|360', '503|359', '504|361', '509|358', '508|359', '507|358', '507|363', '504|370', '531|393'

                   )

    _COORD_LIST_2 = (
        '501|366', '495|364', '491|366', '490|366', '491|373', '485|372', '487|375', '488|376',
        '488|377', '485|377', '488|379', '483|369', '483|370', '485|362', '486|361', '486|369', '488|369', '487|367'
    )
    _COORD_LIST_3 = ('520|365', '523|365', '525|363',
                     '526|362', '524|366', '522|367', '520|367', '522|369', '522|370', '523|371', '521|371', '523|373',
    ...
    TOWNS = (
        # 'https://es61.guerrastribales.es/game.php?village=16779&screen=place'  # Cicumba
